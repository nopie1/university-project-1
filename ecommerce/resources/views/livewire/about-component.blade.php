                ...
                <div class="our-staff">
                    <div
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="NOUR">
                                    <figure><img src="{{asset('assets/images/team/omar.jpg')}}" alt="Nour"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Abdirizak Mohamoud Nour</b>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="FITAH">
                                    <figure><img src="{{asset('assets/images/team/dahir.jpg')}}" alt="fitah"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Abdidahir Abdirizak </b>
                                <span class="title">Back-end developer</span>
                                <p class="desc">Contrary to popular belief, Lorem Ipsum is not simply random text...</p>
                            </div>
                        </div>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="mohamed deeq">
                                    <figure><img src="{{asset('assets/images/team/deq.jpg')}}" alt="Adesh"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Mohamed Abdihakim Mohamed</b>
                                <span class="title">Database Engineer</span>
                                <p class="desc">Contrary to popular belief, Lorem Ipsum is not simply random text...</p>
                            </div>
                        </div>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="Said">
                                    <figure><img src="{{asset('assets/images/team/said.jpeg')}}" alt="abdulla"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Said Ali Hashi</b>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="mohamed deeq">
                                    <figure><img src="{{asset('assets/images/team/deeq1.jpg')}}" alt="Adesh"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">Mohamed Abdirashid</b>
                        ...
                        <div class="team-member equal-elem">
                            <div class="media">
                                <a href="#" title="boss">
                                    <figure><img src="{{asset('assets/images/team/boss.jpeg')}}" alt="Zalman"></figure>
                                </a>
                            </div>
                            <div class="info">
                                <b class="name">abdiladif abdinour a</b>
                                <span class="title">Front-End developer</span>
                                <p class="desc">Contrary to popular belief, Lorem Ipsum is not simply random text...</p>
                            </div>
                        </div>
